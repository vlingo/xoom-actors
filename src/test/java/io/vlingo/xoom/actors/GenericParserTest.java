...
import static io.vlingo.xoom.actors.ProxyGenerator.GenericParser.dependenciesOf;
import static io.vlingo.xoom.actors.ProxyGenerator.GenericParser.genericReferencesOf;
import static io.vlingo.xoom.actors.ProxyGenerator.GenericParser.genericTemplateOf;
import static io.vlingo.xoom.actors.ProxyGenerator.GenericParser.implementsInterfaceTemplateOf;
import static io.vlingo.xoom.actors.ProxyGenerator.GenericParser.parametersTemplateOf;
import static io.vlingo.xoom.actors.ProxyGenerator.GenericParser.returnTypeOf;
...
public class GenericParserTest {
    ...
    public void testThatFindsAllDependenciesOfClassAndItsMethods() {
        ...
        assertThat(dependencySet, hasItems(
                ...
                "java.lang.Object",
                "java.lang.RuntimeException",
                "io.vlingo.xoom.actors.LargeNumber"
        ));
    }
    ...
    public void testThatGeneratesTheCorrectParameterList() {
        ...
        assertEquals("(java.util.function.Function<B, io.vlingo.xoom.actors.Either<NA, NB>> arg0)", result);
    }
    ...
    public void testThatGeneratesAValidClassName() {
        ...
        assertEquals("public class MyNewClass<T extends java.lang.RuntimeException> extends ActorProxyBase<io.vlingo.xoom.actors.MyGenericInterfaceWithMethods> implements io.vlingo.xoom.actors.MyGenericInterfaceWithMethods<T>", result);
    }
