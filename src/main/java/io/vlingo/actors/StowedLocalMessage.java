...
public class StowedLocalMessage<T> extends LocalMessage<T> {
  public StowedLocalMessage(final Actor actor, final Class<T> protocol, final Consumer<T> consumer, final Returns<Object> completes, final String representation) {
